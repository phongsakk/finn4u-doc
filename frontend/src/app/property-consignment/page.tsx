...
function Propertysale() {
	...
	const testposition = "13.8104970155091, 100.56850354191629";
	useEffect(() => {
		try {
		...
		<div className="property-sale">
				...
				<form action={formAction}
					...
					<div className="row filter">
						<div className="col-lg-2">
							<div className="mb-3">
								<FormSelect name="asset_type"
									onChange={
										(e) => setAsTypeSelect(e.target.value)
								}>
			...
			<div className="container">
				<div className="land-sale-2">
					{
					[...Array(3)].map((_, i) => (
						<Link className="not-sale mb-5 property-item pe-auto" href="/property-consignment/detail"
							key={i}>
							<div className="row shadow">
								<div className="col-lg-7">
									<div className="relative">
										{
										i === 0 ? (
											<Map position={testposition}/>
										) : (
											<CustomImage src="/land-img1.png" alt="land-img1"/>
										)
									}
										<span className="badge font2 d-none">ที่ดินเปล่า</span>
