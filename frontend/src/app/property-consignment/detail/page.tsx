						...
						<div className="container">
							<div className="row gallery-grid">
								<div className="col col-lg-9 col-md-9 col-sm-12 col-xs-12">
									<Link className="gallery-item h-100" href="#"
										onClick={handleGallery}>
										<CustomImage src="/locate1.png" className="img-fluid h-100" alt="locate1"/>
									</Link>
								</div>
								<div className="col col-lg-3 col-md-4 col-sm-12 col-xs-12">
									...
									<Link className="gallery-item" href="/locate3.png"
										onClick={handleGallery}>
										<CustomImage src="/locate3.png" className="img-fluid " alt="locate3"/>
									</Link>
									<Link className="gallery-item" href="/locate4.png"
										onClick={handleGallery}>
										<CustomImage src="/locate4.png" className="img-fluid " alt="locate4"/>
									</Link>
								</div>
							</div>
							<div className="time">
								...
								<div className="locataion">
									<ul>
										...
										<li>
											...
											<span className="font2">มูลค่าสินทรัพย์ค้ำประกัน</span>3.2 ล้านบาท
										</li>
										<li>
						...
						<div className="mt-3 fw-bold">
							...
							<div className="row mt-3">
								...
								<div className="row h5 mt-3">
									<label className="col-auto">เปิดประมูลดอกเบี้ยสูงสุดที่:</label>
								...
								<div className="col-sm-4">
									<Button variant="success"
										onClick={handleBid}
										className="px-5 text-nowrap">Bid Now</Button>
								</div>
							</div>
						</div>
					</div>
