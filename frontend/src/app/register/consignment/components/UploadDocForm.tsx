...
import ImageUploadWhite from "@public/upload-white.svg";
    ...
    <form onSubmit={handleSubmit}>
      <div className="row mb-3">
        ...
        <div className="col-lg-6">
          <div className="mb-3">
            <label className="form-label font2">
              ประเภททรัพย์สิน<span className="text-require font2">*</span>
            </label>
        ...
        <div className="col-lg-4">
          <div className="mb-3">
            <label className="form-label font2">
              ขนาดพื้นที่ทรัพย์สิน<span className="text-require font2">*</span>
            </label>
            <input
              type="text"
        ...
        <div className="col-lg-2">
          <div className="mb-3">
            <label className="form-label font2">
              หน่วยเป็น<span className="text-require font2">*</span>
            </label>
      ...
      <p className="mt-3 font2">
        กรุณาอัพโหลดโฉนดที่ดิน(ด้านหน้าและด้านหลังของโฉนดที่ดิน)
        <span className="text-require font2">*</span>
      </p>
      <div className="upload-btn-group">
        <div className="group">
          ...
          <Button variant="primary">
            <Image src={ImageUploadWhite} alt="" />
            อัพโหลด
          </Button>
        </div>
        <div className="group">
      ...
      <div className="row">
        <div className="col-lg-4">
          <label className="form-label font2">
            Location on Google Maps<span className="text-require font2">*</span>
          </label>
          <input
            type="text"
            className="form-control"
