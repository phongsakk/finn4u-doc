...
type NameMultiLanguage struct {
	...
	NameTh string `json:"name_th,omitempty" gorm:"type:varchar(128)"`
	NameEn string `json:"name_en,omitempty" gorm:"type:varchar(128)"`
	NameCn string `json:"name_cn,omitempty" gorm:"type:varchar(128)"`
}
