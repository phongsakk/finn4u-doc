...
type AssetAuction struct {
	...
	FromTime string    `json:"from_time" gorm:"type:time;not null"` // Store time as HH:MM:SS
	ToTime   string    `json:"to_time" gorm:"type:time;not null"`   // Store time as HH:MM:SS
