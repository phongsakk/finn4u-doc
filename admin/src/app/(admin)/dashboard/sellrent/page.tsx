      ...
      <Row className="mb-5 justify-content-between px-4">
          ...
          <Row className="mb-3">
            <div className="col-lg-10">
              <h4 className="fw-bold text-white">
                <span>View</span> <MdAutoGraph className="ps-2" size={30} />
              </h4>
              <div>มีผู้เข้าชม 3,000 ครั้ง</div>
            </div>
            <GrDocumentDownload
              size={20}
          ...
          <Row className="text-success">
            <div className="col-lg-10">
              <h4 className="fw-bold text-success">
                <span>User</span> <MdAutoGraph className="ps-2" size={30} />
              </h4>
              <div>มีผู้เข้าใช้งานเพิ่มขึ้น 250 คน</div>
            </div>
            <GrDocumentDownload
              size={20}
        ...
        <div className="col-lg-3 shadow-lg rounded border p-2">
          <Row className="text-success">
            <div className="col-lg-10">
              <h4 className="fw-bold text-success">
                <span>จำนวนสินทรัพย์</span>
                <MdAutoGraph className="ps-2" size={30} />
              </h4>
              <div>มีผู้โพสประกาศ 250 โพส</div>
            </div>
            <GrDocumentDownload
              size={20}
              className="col-lg-2 justify-self-end"
